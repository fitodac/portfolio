...
var $optionSets = $('nav.primary ul'),
   ...
   $this.addClass('selected'); 
    ...
    function wpgmappity_maps_loaded() {
        ...
        var latlng = new google.maps.LatLng($('#maps').data('lat'), $('#maps').data('lon')); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: https://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
        var styles = [
            {
